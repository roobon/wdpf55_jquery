...
INSERT INTO `attendances` (`id`, `employee_id`, `date`, `clock_in`, `clock_out`, `total_work`, `status`, `created_at`, `modified_at`, `deleted_at`) VALUES
...
INSERT INTO `employee_info` (`Id`, `First_name`, `Last_name`, `Phone`, `Email`, `Age`, `Joining_date`, `Education_exp`, `Add_exp`, `department_id`, `designation_id`, `Bank_name`, `Bank_account_number`, `Salary`, `created_date`, `create_by`, `modified_by`, `modified_date`) VALUES
(1, 'Mr.', 'Y', '01874563252', 'y@gmail.com', 25, '2023-09-11', 'BBA(Hon\'s)in Accounting', 'Marketing Oficer & Wed devoloper', 2, 1, 'AB Bank Ltd.', 7896354, 3500, '2023-09-11 03:07:17', '1', '', '2023-09-11 03:07:17'),
(2, 'MD', 'Alauddin', '01874563252', 'a@gmail.com', 26, '2023-09-16', 'Masters in Acoounting', '2 Years in Sales Marketing ', 1, 2, 'Estarn Bank Ltd.', 6945634, 35000, '2023-09-16 03:08:15', '', '', '2023-09-16 03:08:15');
...
ALTER TABLE `employee_info`
  ...
  ADD CONSTRAINT `fk_employee_designation` FOREIGN KEY (`designation_id`) REFERENCES `employee_designations` (`id`);
COMMIT;
