                    ...
                    <div class="page-content">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="themesflat-headings style-1 clearfix text-center">
                                            <h2 class="heading clearfix">WE MAKE IT EASY</h2>
                                    ...
                                    <div class="col-md-4 border-left-1 border-top-1 border-bottom-1 dark">
                                        <div class="themesflat-icon-box clearfix text-center has-width padding-top-50 padding-right-20 padding-bottom-57 padding-left-25">
                                            <div class="icon-wrap icon-image">
                                                <img src=" <?php echo get_template_directory_uri() ?>/assets/img/iconbox/img-iconbox1.png" alt="Image">
                                            </div>

                                            <h3 class="heading font-size-16 font-weight-700 margin-top-24 margin-bottom-10"><a href="#">INVESTMENT STRATEGY</a></h3>

                                            <p class="desc">We aim at developing and implementing customized and sustainable project financing solutions together with our clients. Derivative instruments to hedge ...</p>
                                    ...
                                    <div class="col-md-4 border-right-1 border-left-1 border-top-1 border-bottom-1 dark">
                                        <div class="themesflat-icon-box clearfix text-center has-width padding-top-50 padding-right-20 padding-bottom-57 padding-left-25">
                                            ...
                                            <h3 class="heading font-size-16 font-weight-700 margin-top-24 margin-bottom-10"><a href="#">FINANCIAL CONTROL</a></h3>

                                            <p class="desc">Loan business play a vital role in keeping your business competitive. In many cases, such measures and investments require capital and funding has to be...</p>
                                        </div><!-- /.themesflat-icon-box -->
                                    </div><!-- /.col-md-4 -->

                                    <div class="col-md-4 border-right-1 border-top-1 border-bottom-1 dark">
                                        <div class="themesflat-icon-box clearfix text-center has-width padding-top-50 padding-right-20 padding-bottom-57 padding-left-25">
                                            <div class="icon-wrap icon-image">
                                                <img src=" <?php echo get_template_directory_uri() ?>/assets/img/iconbox/img-iconbox3.png" alt="Image">
                                            </div>

                                            <h3 class="heading font-size-16 font-weight-700 margin-top-24 margin-bottom-10"><a href="#">MONEY FLOW</a></h3>

                                            <p class="desc">Finance focuses its services on a wide variety of financing solutions as well as for real estate project development and real estate projects. We are specialist for real estate...</p>
                                        </div><!-- /.themesflat-icon-box -->
                                    </div><!-- /.col-md-4 -->

                                    <div class="themesflat-spacer clearfix" data-desktop="55" data-mobi="0" data-smobi="0"></div>

                                    <div class="themesflat-align-box text-center">
                                        <div class="button-wrap icon-left">
                                            <a href="#" class="themesflat-button outline big light padding-left-70 padding-right-70">SEE THE DETAIL</a>
                                        </div>
                                    </div>

                                    <div class="col-md-12">
                                        <div class="themesflat-spacer clearfix" data-desktop="100" data-mobi="60" data-smobi="60"></div>
                                    </div><!-- /.col-md-12 -->
                                </div><!-- /.row -->
                            </div><!-- /.container -->
                        </div>
                        ...
                        <div class="row-accordions bg-light-grey">
                            <div class="container">                                
                                <div class="row equalize sm-equalize-auto">                                   
                                    ...
                                    <div class="col-md-7">
                                        <div class="themesflat-spacer clearfix" data-desktop="72" data-mobi="40" data-smobi="40"></div>
                                        ...
                                        <div class="themesflat-spacer clearfix" data-desktop="33" data-mobi="40" data-smobi="40"></div>

                                        <div class="themesflat-accordions style-3 padding-left-27">
                        ...
                        <div class="row-promotion bg-accent">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="themesflat-spacer clearfix" data-desktop="35" data-mobi="40" data-smobi="40"></div>

                                        <div class="themesflat-action-box style-1 has-icon padding-left-100 padding-right-99">
                                            <div class="inner">
                                        ...
                                        <div class="themesflat-spacer clearfix" data-desktop="28" data-mobi="40" data-smobi="40"></div>
                                    </div><!-- /.col-md-12 -->
                                </div><!-- /.row -->
                            </div><!-- /.container -->
                        </div>
                        ...
                        <div class="row-services">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="themesflat-spacer clearfix" data-desktop="97" data-mobi="60" data-smobi="60"></div>
                                    </div><!-- /.col-md-12 -->
                                </div><!-- /.row -->
                            </div><!-- /.container -->
                        </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="themesflat-contact-form style-3 padding-left-56">
                                            ...
                                            <form action="./includes/contact/contact-process.php" method="post" class="contact-form wpcf7-form">
                                                ...
                                                <span class="your-notification color-white font-size-14 padding-left-37">Thank you for your interest in <a href="#">Finance Group</a>.</span>
                                            </form>
                                        </div><!-- /.themesflat-contact-form -->
                                    </div><!-- /.col-md-8 -->

                                    <div class="col-md-12">
                                        <div class="themesflat-spacer clearfix" data-desktop="89" data-mobi="60" data-smobi="60"></div>
                                    </div><!-- /.col-md-12 -->
                                </div><!-- /.row -->
                            </div><!-- /.container -->
                        </div>
                        ...
                        <div class="row-testimonials">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="themesflat-spacer clearfix" data-desktop="111" data-mobi="60" data-smobi="60"></div>

                                        <div class="themesflat-headings style-1 padding-left-3 clearfix text-center">
                                            <h2 class="heading clearfix">WHAT THEY SAY ABOUT US</h2>
                                            <div class="sep clearfix"></div>
                                            <p class="sub-heading clearfix">Appropriate and sufficient financing for a company is crucially important for its long-term success. We advise you in choosing the appropriate type of financing</p>
                                        </div><!-- /.themesflat-headings -->
                            ...
                            <div class="container-fluid">
                                <div class="row equalize sm-equalize-auto">
                                    <div class="col-md-6 bg-light-grey">
                                        ...
                                        <div class="themesflat-content-box clearfix " data-margin="0% 14% 0% 24.1%" data-mobimargin="0% 5% 0% 5%">
                                            <div class="themesflat-headings style-4 clearfix">
                                                <h2 class="heading clearfix">OUR COMMITMENT TO YOU</h2>
                                                <div class="sep clearfix"></div>
                                                <p class="sub-heading clearfix">We're proud to provide cutting-edge expertise in areas including planning investments, taxes, estate, insurance, income and education.</p>
                                            </div><!-- /.themesflat-headings -->

                                            <div class="themesflat-spacer clearfix" data-desktop="36" data-mobi="40" data-smobi="40"></div>

                                            <div class="themesflat-progress style-2 clearfix height-9px">
                                            ...
                                            <div class="themesflat-spacer clearfix" data-desktop="37" data-mobi="40" data-smobi="40"></div>
                                            ...
                                            <div class="themesflat-progress style-2 clearfix height-9px">
                                                <h3 class="title">REVENUE & INCOM</h3>
                                                <div class="perc-wrap">
                                    ...
                                    <div class="col-md-6 half-background style-4">
                                        <div class="themesflat-icon style-6 clearfix background">
                                            <a class="icon-wrap popup-video" href="https://www.youtube.com/watch?v=LQpedLhpQsk">
                                                <span class="icon"><i class="finance-icon-Playbutton1"></i></span>
                                            </a>
                                        </div><!-- /.themesflat-icon -->
                                    </div>
